...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="杨波"/>
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="南京有点"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="通达学院 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">杨波</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">138****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">江苏 南京</div>
						<div class="adr-m" limit="30">南京邮电大学通达学院 xxxxxxxxx</div>
